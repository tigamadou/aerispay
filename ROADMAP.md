...
**Index des specs MVP (v1.1.0 doc) :** `SPECS/PAGES_MVP.md` (inventaire des écrans) ; `SPECS/AUTH.md` ; `SPECS/STOCK.md` ; `SPECS/CAISSE.md` ; `SPECS/IMPRESSION.md` ; `SPECS/PERIPHERIQUES.md` ; `SPECS/ACTIVITY_LOG.md` ; `SPECS/MULTI_ORGANISATION.md` (cible long terme).
...
**Objectif :** KPIs, exports, **journal d’activité** complet.  
**Specs :** `PAGES_MVP` (Dashboard, `activity-logs`), `ACTIVITY_LOG.md`, `ARCHITECTURE_MVP` §7–8.

- [ ] **[DASH-01]** `GET /api/dashboard/kpis`
- [ ] **[DASH-02]** Page dashboard (`/`)
