...
- [ ] **[LOG-01]** Journal d’activité — données & utilitaire
  ...
  - **⚠️ Dépendance :** ce ticket devrait idéalement être terminé avant Phase 1, car les modules Stock, Caisse et Auth appellent `logActivity` dès leur implémentation. Si LOG-01 est différé à Phase 4, les appels `logActivity` dans les phases précédentes doivent être ajoutés en instrumentation différée (LOG-02).
