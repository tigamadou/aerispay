...
**Index des specs MVP (v1.1.0 doc) :** `SPECS/PAGES_MVP.md` (inventaire des écrans) ; `SPECS/DASHBOARD.md` (KPI & `GET /api/dashboard/kpis`) ; `SPECS/AUTH.md` ; `SPECS/STOCK.md` ; `SPECS/COMPTOIR.md` ; `SPECS/IMPRESSION.md` ; `SPECS/PERIPHERIQUES.md` ; `SPECS/ACTIVITY_LOG.md` ; `SPECS/MULTI_ORGANISATION.md` (cible long terme).
...
Phase 2 — Module Comptoir (Semaines 4–5)
...
- [ ] **[SETUP-06]** Périmètre matériel caisse (abstractions, tests, config env)  
  - `SPECS/PERIPHERIQUES.md` · alignement `COMPTOIR` / `IMPRESSION`  
...
**Specs :** `SPECS/COMPTOIR.md`, `SPECS/PERIPHERIQUES.md`, `SPECS/PAGES_MVP.md` (Comptoir).

### Sprint 2.1 — Sessions de Comptoir
- [ ] **[CAISSE-API-01]** API `GET/POST /api/comptoir/sessions`
- [ ] **[CAISSE-API-02]** API `PUT /api/comptoir/sessions/[id]`
- [ ] **[CAISSE-UI-01]** Page sessions (`/comptoir/sessions`)

### Sprint 2.2 — Interface POS
- [ ] **[CAISSE-UI-02]** Interface POS (`/comptoir`)
...
- [ ] **[CAISSE-UI-05]** Page historique (`/comptoir/ventes`)
...
**Specs :** `SPECS/IMPRESSION.md`, `SPECS/PERIPHERIQUES.md`, `PAGES_MVP` (`/comptoir/tickets/[id]`).

### Sprint 3.1 — Ticket PDF
- [ ] **[PRINT-01]** `lib/receipt/pdf-generator.ts`
- [ ] **[PRINT-02]** `GET /api/tickets/[id]/pdf`
- [ ] **[PRINT-03]** Page `/comptoir/tickets/[id]`
...
- [ ] **[LOG-02]** Instrumentation `logActivity` (auth, users, stock, comptoir, tickets)
