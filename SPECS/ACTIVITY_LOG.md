...
## Objectif
Conserver une **trace horodatée et consultable** de l’essentiel des actions effectuées dans AerisPay (authentification, gestion des utilisateurs, stock, comptoir, tickets, etc.), à des fins d’**audit**, de **support** et de **conformité** opérationnelle.
...
| Comptoir | `COMPTOIR_SESSION_OPENED`, `COMPTOIR_SESSION_CLOSED`, `SALE_COMPLETED`, `SALE_CANCELLED` |
...
- [ ] Erreur matériel comptoir (imprimante / tiroir / scan inconnu) → action pertinente sans donnée sensible
