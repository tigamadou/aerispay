...
export const ACTIONS = {
  ...
  SESSION_CLOSURE_REQUESTED: "SESSION_CLOSURE_REQUESTED",
  ...
  // Comptoir — mouvements de caisse
  CASH_MOVEMENT_CREATED: "CASH_MOVEMENT_CREATED",

  // Comptoir — integrite & ecarts
  ...
  // Terminaux de caisse (F1.1) — valeurs de chaîne historiques conservées (intégrité de l'audit)
